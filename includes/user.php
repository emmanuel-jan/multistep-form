...
//User class for account creation and login purpose
    class User{
        ...
        function __construct(){
            ...
            $db = new Database(); //creating class Database Object 
            $this->con = $db->connect();
        }

        private function emailExists($email){
            //To protect your application form sql attacks you can use prepared statements
    ...
    // $user = new User();
    // echo $user->createUserAccount("Luke", "luke1@gmail.com", "122332", "other");
    // echo $user->userLogin("luke@gmail.com", "122332");
